...
DEFAULT_ROBOT_ROUTES: Mapping[str, tuple[str, str, float]] = {
    ...
    "manual_tip_set": ("POST", "/motion/oem/calibration_settings/manual_tip_set", 120.0),
    "operation_parameters": ("GET", "/liquid/oem/operation_parameters", 10.0),
    "save_operation_parameters": ("PATCH", "/liquid/oem/operation_parameters", 10.0),
...
class BioXpRobotClient:
    ...
    async def probe(self) -> dict[str, Any]:
        """Passive observation only; collection belongs to explicit operator actions."""
        return await self.probe_status_only()
