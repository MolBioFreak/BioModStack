...
_RESULT_CONTRACT_DEFINITIONS: List[ResultContractDefinition] = [
    ...
    ResultContractDefinition(
        ...
        stage_modes=["local_redesign"],
        artifact_classes=["rfd3_local_redesign_candidate"],
        result_sets=["rfd3_local_redesign_candidates"],
        supported_analyzers=[*_STRUCTURE_ANALYZERS, *_CONFIDENCE_ANALYZERS],
        viewer_capabilities=[
            "result_filter",
            "structure_viewer",
            "rfd3_input_overlay",
            "rfd3_region_overlay",
            "rfd3_per_residue_metrics",
            "rfd3_trajectory_viewer",
            "rfd3_candidate_comparison",
            "sequence_policy_audit",
            "provenance_audit",
            "content_addressed_download",
        ],
        required_fields=["artifact_class", "result_set", "rfd3_request_sha256"],
        required_artifacts=[
            "source_structure",
            "native_request",
            "native_prediction_metadata",
            "structure",
            "rfd3_result_manifest",
        ],
        notes="Native RFD3 local-redesign candidates with explicit sequence and region provenance.",
    ),
    ResultContractDefinition(
    ...
    ResultContractDefinition(
        ...
        model_ids=["fampnn", "proteinmpnn", "antifold", "caliby"],
        stage_families=["fampnn", "proteinmpnn", "antifold", "caliby"],
    ...
    ResultContractDefinition(
        contract_id="frustration_analysis_v1",
        model_ids=["frustrampnn"],
        stage_families=["frustrampnn"],
        supported_analyzers=["frustration_landscape"],
        viewer_capabilities=[
            "structure_viewer",
            "frustration_landscape",
            "substitution_landscape",
            "residue_mapping",
            "content_addressed_download",
        ],
        required_fields=["candidate_id", "manifest_sha256"],
        required_artifacts=[
        ...
        notes="FrustraMPNN residue-frustration mapping and complete substitution-landscape analysis; not sequence design.",
    ),
    ResultContractDefinition(
