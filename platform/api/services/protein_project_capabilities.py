...
def _structure_prediction_schemas() -> dict[str, dict[str, Any]]:
    ...
    return {
        ...
        "protein.structure_prediction.boltz2": _schema("protein.structure_prediction.boltz2", "Governed Boltz-2 structure prediction settings", boltz, boltz_required, authority="typed_core_job_outside_project_manager"),
        "protein.structure_prediction.protenix_v2": _schema("protein.structure_prediction.protenix_v2", "Governed Protenix V2 structure prediction settings", protenix, protenix_required, authority="typed_core_job_outside_project_manager"),
    }
...
_CAPABILITIES = [
    _capability("protein.structure_prediction.boltz2", label="Boltz-2 structure prediction", family="structure_prediction", category="structure_prediction", role="folding_structure_prediction", allowed_modes=["prediction", "validation"], plannable=False, exposure_state="accepted", availability_state="operational_outside_project_manager", availability_reason="Project capability dispatch is not yet connected to the existing typed core Job authority.", workflow_family="typed_core_job", workflow_adapter_id="bms.core-job.boltz2.adapter.v1", launch_mode="typed_launcher_handoff", destination="/submit?template=structure_prediction", model_modes=[{"model_id": "boltz2", "mode": "predict"}], result_adapter_ids=["bms.core-job.boltz2.adapter.v1", "bms.core.protein-result-reference.adapter.v1"], result_contracts=["structure_prediction_v1", "typed_core_job_result"], viewer_id="structure_viewer", accepted_source_roles=["target_structure_receipt"], receipt_contracts=["bms.global.external-entity-receipt.v1"]),
    _capability("protein.structure_prediction.esmfold2", label="ESMFold2 structure prediction", family="structure_prediction", category="structure_prediction", role="folding_structure_prediction", allowed_modes=["prediction"], plannable=True, exposure_state="accepted", availability_state="operational", availability_reason=None, workflow_family="typed_core_job", workflow_adapter_id=ADAPTER_ID, launch_mode="typed_launcher_handoff", destination="/submit?template=structure_prediction", model_modes=[{"model_id": "esmfold2", "mode": "predict"}], result_adapter_ids=[ADAPTER_ID, "bms.core.protein-result-reference.adapter.v1"], result_contracts=["core_job_result", "typed_core_job_result"], viewer_id="structure_viewer", accepted_source_roles=["target_structure_receipt"], receipt_contracts=["bms.global.external-entity-receipt.v1"]),
    _capability("protein.structure_prediction.protenix_v2", label="Protenix V2 structure prediction", family="structure_prediction", category="structure_prediction", role="folding_structure_prediction", allowed_modes=["prediction", "validation"], plannable=False, exposure_state="accepted", availability_state="operational_outside_project_manager", availability_reason="Project capability dispatch is not yet connected to the existing typed core Job authority.", workflow_family="typed_core_job", workflow_adapter_id="bms.core-job.protenix.adapter.v1", launch_mode="typed_launcher_handoff", destination="/submit?template=structure_prediction", model_modes=[{"model_id": "protenix", "mode": "predict"}], result_adapter_ids=["bms.core-job.protenix.adapter.v1", "bms.core.protein-result-reference.adapter.v1"], result_contracts=["structure_prediction_v1", "typed_core_job_result"], viewer_id="structure_viewer", accepted_source_roles=["target_structure_receipt"], receipt_contracts=["bms.global.external-entity-receipt.v1"]),
