...
@pytest.mark.parametrize(
    ...
    [
        {},
        {"enzyme_name": "BsmBI"},
        {"enzyme_id": "BsaI", "recognition_site": "GGTCTC"},
        {"enzyme_id": "BsaI", "site": "GGTCTC"},
        {"enzyme_id": "BsaI", "cut_index": 1},
        {"enzyme_id": "BsaI", "top_offset": 7, "bottom_offset": 11},
    ],
)
...
def test_public_golden_gate_routes_translate_typed_dna_failures_without_persistence(
    ...
    response = TestClient(app).post(
        ...
        json={"fragments": [], "circular": False, "enzyme_id": "BsaI"},
    )
...
def test_save_persists_structured_authority_from_the_simulated_product(
    ...
    request = molbio_ops.GoldenGateAssemblyRequest(
        fragments=[], circular=False, enzyme_id="BsmBI"
    )
