...
def payload(age: float = 6, **refresh):
    return {'runtime_ready':True, 'available':True, 'cache_state':'fresh',
            'freshness':{'state':'fresh','age_s':age,'fresh_for_s':30},
            'admission_observation': {'available':True, 'cache_state':'fresh',
                'freshness':{'state':'fresh','age_s':age,'fresh_for_s':30}},
            'deck_authority': {'available':True,
                'freshness':{'state':'fresh','age_s':age,'fresh_for_s':15}},
