...
import { buildGoldenGateAssemblyRequest } from '../src/lib/goldenGateAuthority';
...
test('Golden Gate request contract requires stable catalog identity', () => {
...
test('production request boundary submits only an explicit currently loaded stable ID', () => {
