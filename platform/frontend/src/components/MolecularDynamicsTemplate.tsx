                ...
                <div className="space-y-5">
                    ...
                    <section className={panelClass}>
                        ...
                        <div className="grid gap-4 md:grid-cols-3">
                            ...
                            <NumberField label="Trajectory interval" unit="ps" value={form.trajectoryIntervalPs} min={0.002} step={1} onChange={(value) => update('trajectoryIntervalPs', value)} />
                            <NumberField label="Energy/log interval" unit="ps" value={form.energyIntervalPs} min={0.002} step={0.5} onChange={(value) => update('energyIntervalPs', value)} />
