        ...
        <div className="mx-auto w-full space-y-5" data-bms-md-launcher="gen2">
            <header className="flex flex-wrap items-start justify-between gap-4">
                <div>
                    ...
                    <div className="flex items-center gap-3"><h1 className="text-2xl font-bold text-slate-100">Molecular Dynamics Gen 2</h1><span className="rounded-full border border-orange-400/30 bg-orange-500/10 px-2 py-1 text-[10px] font-semibold uppercase tracking-wider text-orange-300">Experimental alpha</span></div>
