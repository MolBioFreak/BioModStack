...
/** Visible even when canonical/B2 failure makes the workspace lens unavailable. */
export const StateLandscapeStatusAlert = ({ error }: { error: string | null | undefined }) => error
    ? <div role="alert" className="rounded-xl border border-red-500/30 bg-red-500/10 p-3 text-sm text-red-200">State analysis is unavailable: {error}</div>
    : null;
