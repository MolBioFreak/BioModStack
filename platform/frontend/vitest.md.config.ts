...
export default defineConfig({
    ...
    test: {
        ...
        include: [
            ...
            './tests/vitest/genericSequenceLaunchCloseout.test.tsx',
            ...
            './tests/vitest/executionPolicyMounted.test.tsx',
            './tests/vitest/executionPolicySubmissionMounted.test.tsx',
            ...
            './tests/vitest/frustraMpnnResultsNavigation.test.tsx',
            ...
            './tests/vitest/resultsViewerNavigation.test.tsx',
            './tests/vitest/proteinProjectReopen.test.tsx',
            ...
            './tests/vitest/molbio-sanity-*.test.tsx',
            './tests/vitest/restrictionAnalysis.test.ts',
