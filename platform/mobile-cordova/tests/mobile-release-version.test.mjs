...
test('native shell release version advances beyond the installed 0.4.3 APK', async () => {
  ...
  assert.match(configXml, /version="0\.4\.4"/);
  assert.match(configXml, /android-versionCode="404"/);
