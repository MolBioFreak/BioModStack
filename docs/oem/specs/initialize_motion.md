# OEM Spec: initialize_motion

**OEM method/source:** ControlLib.initializeMotion
**Source anchor:** ControlLib.cs

## Summary

App-level initialization wrapper around motion initialization plus pipette/tip cleanup/recovery and UI/machine-state handling.

## Implementation rule

Must model tip/pipette branch; initial implementation may mark branch missing/blocked rather than silently omit it.
