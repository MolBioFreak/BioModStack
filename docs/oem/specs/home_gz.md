...
**OEM method/source:** ClassControlInterface.homeGZ
**Source anchor:** ClassControlInterface.cs

## Summary

Composite Z/G routine including pseudo-Z-home, delayed gripper home, caught-plate recovery chain involving X home/solenoid/latch false/throw.

## Implementation rule

Do not claim parity unless caught-plate path is implemented or explicitly marked missing.
