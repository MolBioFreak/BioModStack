  ...
  refreshEnzymeGroups = () => {
    ...
    this.enzymeGroups = {
      ...
      "NEB Common": {
        protected: true,
        name: "NEB Common",
        tooltipInfo: "Common restriction enzymes from the NEB catalog including Golden Gate assembly enzymes.",
        enzymes: getEnzymesForNames([
          // Standard restriction enzymes
          "bamhi", "ecori", "hindiii", "xhoi", "noti", "xbai",
          "sali", "psti", "kpni", "saci", "sphi", "ncoi", "ndei",
          "bglii", "clai", "smai", "stui", "nhei", "bsrgi", "avrii",
          "nrui", "ecorv", "scai", "pvuii", "pvui", "mlui",
          // Golden Gate / MoClo enzymes
          "bsai", "bsmbi", "btgzi", "esp3i", "sapi", "bbsi", "bfuai"
        ].filter(n => this.getAllEnzymesByName()[n]), this.getAllEnzymesByName())
      },
      ...reduce(
