...
import { branchHook as branch, renderComponentHook as renderComponent } from "../utils/recomposeCompat";
          ...
          [
            {
              divider: (
                ...
                >{`Trim ${track.sequenceData.name || track.sequenceData.id
                  }...`}</div>
              )
            },
            {
                ...
                {isTemplate ? (
                  ...
                  <ReactList
                    ref={c => {
                      ...
                      // Fallback for React 19: check if 'el' property exists on ReactList or use c directly if it's an element
                      const domNode = c?.el || c;
