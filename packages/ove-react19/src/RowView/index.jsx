...
class _RowView extends React.Component {
  // React 19 compatible ref for Draggable - avoids findDOMNode
  draggableNodeRef = React.createRef();
  ...
  getRef = ref => {
    this.node = ref;
    // Also update draggableNodeRef for React 19 compatibility
    if (this.draggableNodeRef) {
      this.draggableNodeRef.current = ref;
    }
  };
