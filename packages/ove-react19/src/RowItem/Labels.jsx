...
import { onlyUpdateForKeysHook as onlyUpdateForKeys } from "../utils/recomposeCompat";
    ...
    annotationsSVG.push(
      <DrawLabel
        ...
        {...{
          ...
          annotation,
          noLabelLine,
          className: `${annotationRange.annotation.labelClassName || ""} ${labelClassNames[pluralType]
            } veLabel `,
          isProtein,
          xStartOriginal,
