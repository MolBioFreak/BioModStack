...
import BlueprintPortalContext from "../contexts/BlueprintPortalContext";
...
import { withHandlersHook as withHandlers } from "../utils/recomposeCompat";
...
export class Editor extends React.Component {
  ...
  // NOTE: Legacy getChildContext removed for React 19 compatibility.
  // BlueprintPortalContext.Provider is now used in render() instead.
  ...
  render() {
    ...
    return (
      <BlueprintPortalContext.Provider value="ove-portal">
        <React.Fragment>
          <DropHandler
            key="dropHandler"
          ...
          className={`veEditor ${editorName} ${previewModeFullscreen ? "previewModeFullscreen" : ""
            }`}
        >
          <ToolBar
            {...pickedUserDefinedHandlersAndOpts}
      ...
      </BlueprintPortalContext.Provider>
    );
  }
}

// NOTE: childContextTypes removed for React 19 compatibility.
// Context is now provided via BlueprintPortalContext.Provider in render().
