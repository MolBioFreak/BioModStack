...
process PrepRFD3Input {
    ...
    output:
    tuple val(batch_id), path("rfd3_input_*.json"), emit: input_json
...
process FilterRFD3 {
    ...
    output:
    tuple path("filtered_output/*.cif.gz"), path("filtered_output/*.json"), emit: structures_metadata, optional: true
